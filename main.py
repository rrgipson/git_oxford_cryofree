...
class Application:
    ...
    def start_bg_logging(self, *args):
        if (self.serial_t.is_open or self.serial_m.is_open) and self._bglog_thread == None:
            ...
            if self._temp_connect:
                self.bglogger.assign_temp_log_fxns(get_vti_temp=self.get_vti_temp, get_sample_temp=self.get_sample_temp, get_nv_pressure=self.get_nv_value, get_temp_set=self.get_temperature)

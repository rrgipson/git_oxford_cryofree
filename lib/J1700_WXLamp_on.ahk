; AutoHotKey script for turning on the Tungsten Halogen Lamp on the J1700 Spectra Measurement Software.
...
; Search Spectra Measurement window for the WX lamp button image within the specified X1, Y1, X2, and Y2 window pixel area
; Store the location as FoundX and FoundY
ImageSearch, FoundX, FoundY, 150, 50, 1920, 550, C:\Users\Jasco\Desktop\git_oxford_cryofree\lib\J1700_WXLamp_off.png
...
FileAppend, Tungsten Halogen Lamp On Button Found at X= %FoundX% and Y= %FoundY%, *
